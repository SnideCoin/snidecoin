...
const string strMessageMagic = "snide Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 1)
  {
    ...
    else if(pindexBest->nHeight+1 >= 2 && pindexBest->nHeight+1 <= 25000)
  {
    nSubsidy = 5 * COIN;
  }
  else if(pindexBest->nHeight+1 >= 25001 && pindexBest->nHeight+1 <= 50000)
  {
  nSubsidy = 25 * COIN;
  }
  else if(pindexBest->nHeight+1 >= 50001 && pindexBest->nHeight+1 <= 75000)
  {
  nSubsidy = 20 * COIN;
  }
  else if(pindexBest->nHeight+1 >= 75001 && pindexBest->nHeight+1 <= 100000)
  {
  nSubsidy = 15 * COIN;
  }
  else if(pindexBest->nHeight+1 >= 100001 && pindexBest->nHeight+1 <= 94675000)
  {
  nSubsidy = 5 * COIN;
  }
...
// snide: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "snide", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "SNIDECOIN";
        CTransaction txNew;
        txNew.nTime = 1523549984;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x8309b34a03ae1f26625bba2cc33d99c0a77fea402862cf8eeaeab0dac9ac1a9c"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd1, 0xf4, 0xf5, 0xd1 };
